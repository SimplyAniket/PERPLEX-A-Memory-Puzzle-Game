...
class Tile(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.name = game.split('.')[0]

        self.original_image = pygame.image.load('images/image/' + game)

        self.back_image = pygame.image.load('images/image/' + game)
...
class Game():
    def __init__(self):
        ...
        # aliens
        self.all_aliens = [f for f in os.listdir('images/image') if os.path.join('images/image', f)]
    ...
    def draw(self):
        ...
        # text
        title_text = title_font.render('PERPLEX', True, WHITE)
        ...
        info_text = content_font.render('Match pairs of tiles', True, WHITE)
    ...
    def get_video(self):
        self.cap = cv2.VideoCapture('video/goku.mp4')
        self.success, self.img = self.cap.read()
...
pygame.display.set_caption('PERPLEX')
